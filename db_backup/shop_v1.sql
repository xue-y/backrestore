...
DROP TABLE IF EXISTS `ecs_account_log2`;
CREATE TABLE `ecs_account_log2` (
...
INSERT INTO `ecs_account_log2`(`log_id`, `user_id`, `user_money`, `frozen_money`, `rank_points`, `pay_points`, `change_time`, `change_desc`, `change_type`) VALUES (1,2,'1100001.00','0.00',0,0,1242140736,'11',2),
...
DROP TABLE IF EXISTS `ecs_ad1`;
CREATE TABLE `ecs_ad1` (
...
INSERT INTO `ecs_ad1`(`ad_id`, `position_id`, `media_type`, `ad_name`, `ad_link`, `ad_code`, `start_time`, `end_time`, `link_man`, `link_email`, `link_phone`, `click_count`, `enabled`) VALUES (1,1,0,'测试广告','','1462958213922967180.jpg',1462003200,1527667200,'','','',4,1),
